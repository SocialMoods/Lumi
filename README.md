...
### What's new in Lumi?
1. Support for 1.20.0 – 1.26.44 version (you can set the minimum protocol in the config)
...
3. Write a command to run: `java -jar Lumi-1.6.6.jar`
...
Adding dependency:
```kts
compileOnly("com.koshakmine:Lumi:1.6.6-SNAPSHOT")
```
